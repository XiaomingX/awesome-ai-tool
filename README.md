...
10. **ChatGPT for Jupyter**：在Jupyter Notebook和Lab中添加多种ChatGPT功能。[点击访问](https://github.com/TiesdeKok/chat-gpt-jupyter-extension)  
...
3. **[Stableboost](https://stableboost.ai/)**  
   一个方便生成大量图像的Web界面。
